...
import com.algaworks.algalog.domain.service.FinalizingDeliveryService;
...
public class DeliveryController {
  ...
  @Autowired
  private FinalizingDeliveryService finalizingDeliveryService;
  ...
  public void finish(@PathVariable Long deliveryId) {
    finalizingDeliveryService.finish(deliveryId);
  }
}
